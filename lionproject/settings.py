...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-x0384)f25_(7(epm1*$!n_o+(c*37u_dl!%pp$vqnr)-s%(1ev')
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # 이용자 업로드 파일 모으는 곳
MEDIA_URL = '/media/'
...
AWS_STORAGE_BUCKET_NAME = 'likelion-django-study'
